...
- For dependencies in `package.json` or `import`/`export` statements in code files, or other most common places where a package name might appear, provide a way to navigate to
