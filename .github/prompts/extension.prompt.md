...
- For dependencies in `package.json`, `pnpm-workspace.yaml`, `import`/`export` statements in JavaScript/TypeScript code files, or other most common places where a package name might appear, provide a way to navigate to
