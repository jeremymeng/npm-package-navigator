...
export class PackageDetector {
    getPackageAtCursor(document: vscode.TextDocument, position: vscode.Position): PackageMatch | undefined {
    ...
    private extractFromPackageJson(document: vscode.TextDocument, position: vscode.Position): PackageMatch | undefined {
    ...
    private findRangeForDependency(document: vscode.TextDocument, packageName: string): vscode.Range | undefined {
